...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BmObstruction")));
bytes32 constant BmObstructionTableId = _tableId;

library BmObstruction {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BmObstruction", _fieldNames);
  }
