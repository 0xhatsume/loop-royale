...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BmItemCount")));
bytes32 constant BmItemCountTableId = _tableId;
...
library BmItemCount {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BmItemCount", _fieldNames);
  }
