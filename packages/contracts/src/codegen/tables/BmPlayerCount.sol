...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BmPlayerCount")));
bytes32 constant BmPlayerCountTableId = _tableId;

library BmPlayerCount {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BmPlayerCount", _fieldNames);
  }
